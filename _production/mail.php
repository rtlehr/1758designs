...
$mail->SetFrom('info@1758designs.com', 'Ross Lehr');

$mail->AddReplyTo("info@1758designs.com","Ross Lehr");

$mail->Subject    = "PHPMailer Test Subject via smtp, basic with authentication ASSETS";

$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test

$mail->MsgHTML($body);

$address = "ross.lehr@gmail.com";
